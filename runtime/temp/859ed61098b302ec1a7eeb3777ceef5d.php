<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\xampp\htdocs\application/application/admin\view\student\index.html";i:1514976774;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('student/useradd')): ?>
                <a href="<?php echo url('student/userAdd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加学生</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <th data-field="username">学生名称</th>
...
<script type="text/javascript">
    ...
    function userDel(id){
        layer.confirm('确认删除此学生?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('student/userDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
