<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\wamp64\www\heheyun/application/index\view\student\task_list.html";i:1518090189;s:69:"D:\wamp64\www\heheyun/application/index\view\common\student_head.html";i:1518090190;s:69:"D:\wamp64\www\heheyun/application/index\view\common\stu_leftMinu.html";i:1518090190;s:63:"D:\wamp64\www\heheyun/application/index\view\common\static.html";i:1518090190;}*/ ?>
<!-- 头部引入 -->
...
<script type="text/javascript">
    $("#stu_menu a").removeClass("charset");
    $("#stu_menu a.task").addClass("charset");
</script>
<!-- 内容 -->
                    ...
                    <div class="head_tab hide">
                        ...
                        <ul class="subject_ul">
                            <?php if(is_array($subject) || $subject instanceof \think\Collection || $subject instanceof \think\Paginator): $i = 0; $__LIST__ = $subject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == $defsubject['id']): ?>
                                 ...
                                 <?php else: ?>   
                                    <li id="4" onclick="sbj_click(this)">
                                        <a><?php echo $vo['title']; ?></a>
                                    </li>
                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                ...
                <div class="resource_nav">
                    <ul class="navT_ul">
                        <li class="active" id="after">
                            <a>课后作业</a>
                            <span class="red_point" style="display: none;"></span>
                        </li>
                        <li id="before">
                            <a>课前预习</a>
                            <span class="red_point" style="display: none;"></span>
                   ...
                   <!-- 待完成 -->
                    <!-- <li class="source_li">
                        ...
                        <div class="operate_a float_right">
                            ...
                            <a class="float_right" href="<?php echo url('/index/student/do_task'); ?>" onclick="">查看</a>
                        </div>
                    </li> -->
                    <!-- 批阅中 -->
                   <!--  <li class="source_li">
