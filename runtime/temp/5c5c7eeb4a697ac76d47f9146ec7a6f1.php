<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\xampp\htdocs\application/application/admin\view\circle\circletype.html";i:1517399352;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                ...
                <a href="<?php echo url('circle/ntypeAdd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加类型</button>
                </a>
                <?php endif; ?>
            </div>
...
<script type="text/javascript">
    ...
    function noticeDel(id){
        layer.confirm('确认删除此学生?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('circle/noticeDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
