...
<!-- 内容 -->
<link rel="stylesheet" type="text/css" href="__STATIC__/index/student/css/reviseHing.css">
<link rel="stylesheet" type="text/css" href="__STATIC__/index/student/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="__STATIC__/index/student/css/cropper.min.css">
<link rel="stylesheet" type="text/css" href="__STATIC__/index/student/css/sitelogo.css">
<!-- <script type="text/javascript" src="__STATIC__/index/teacher/js/reviseHimg.js"></script> -->
<script type="text/javascript" src="__STATIC__/index/student/js/bootstrap.min.js"></script>
<script type="text/javascript" src="__STATIC__/index/student/js/cropper.min.js"></script>
<script type="text/javascript" src="__STATIC__/index/student/js/sitelogo.js"></script>

<div class="teainfo_conts">
    <div class="tea_ifcont tea_check0">
        <a href="<?php echo url('/index/student/myindex'); ?>">我的信息</a>
        <a href="<?php echo url('/index/student/reviseHimg'); ?>" style="color: #fff;">头像</a>
