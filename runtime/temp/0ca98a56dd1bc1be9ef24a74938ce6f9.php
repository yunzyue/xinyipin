<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\xampp\htdocs\application/application/admin\view\resource\course.html";i:1514976774;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox float-e-margins">
            ...
            <div class="form-group clearfix col-sm-1">
                ...
                <a href="__URL__/videoAdd?type=course">
                    <button class="btn btn-outline btn-primary" type="button">添加课件</button>
                </a>
                <?php endif; ?>
            </div>
