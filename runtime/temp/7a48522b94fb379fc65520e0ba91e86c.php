<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\wamp64\www\taidaxin/application/admin\view\login.html";i:1520674411;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎登录 <strong>泰达鑫管理后台</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到泰达鑫管理后台</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017-2019 All Rights Reserved. taidaxin
        </div>
    </div>
</div>
