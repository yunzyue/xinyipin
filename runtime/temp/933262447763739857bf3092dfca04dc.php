<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\heheyun/application/index\view\teacher\homepage.html";i:1520040807;s:69:"D:\wamp64\www\heheyun/application/index\view\common\teacher_head.html";i:1519786633;s:63:"D:\wamp64\www\heheyun/application/index\view\common\static.html";i:1519786633;}*/ ?>
...
<div id="homepage">
				...
				<div id="hwlis_cons" class="fl">
					...
					<div class="hwork_lis " >
						...
						<div class="hwork_py">
							...
							<a href="javascript:piyue('<?php echo $nw['wid']; ?>');">批阅＞</a>
						</div>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
	...
	<div class="hwMidd">
		<div class="wmidd_left fl">
			<div class="wmlef_tit">
				...
				<a href="__URL__/resource?prelesson">更多＞</a>
			</div>
			<ul id="wmlef_cont">
		...
		<div class="wmidd_right fl">
			<div class="wmlef_tit">
				...
				<a href="__URL__/schoolindex">更多＞</a>
			</div>
			<ul id="wmlef_cont">
	...
	<!-- 底部 -->
	<div class="wave_box" style="margin-bottom: 20px;">
...
<script type="text/javascript">
	...
	function piyue(wid){
		...
		var cid=window.cid;
		var wid=wid;
		window.location.href='__URL__/marklist/classid/'+cid+'/id/'+wid;
	}
</script>
