<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp64\www\heheyun/application/admin\view\resource\outline.html";i:1519865828;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('resource/outlineadd')): ?>
                <a href="<?php echo url('resource/outlineadd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加大纲</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
...
<script type="text/javascript">
    ...
    function userDel(id){
        layer.confirm('确认删除此管理员?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('resource/outlineDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
