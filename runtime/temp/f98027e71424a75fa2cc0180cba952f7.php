<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp64\www\heheyun/application/index\view\teacher\prelessonlist.html";i:1519961985;}*/ ?>
<?php if($prelessonlist!=''): if(is_array($prelessonlist) || $prelessonlist instanceof \think\Collection || $prelessonlist instanceof \think\Paginator): $i = 0; $__LIST__ = $prelessonlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    		<li class="source_li">
                ...
                <div class="operate_a float_right">
                    ...
                    <a href="<?php echo $vo['addresss']; ?>?title=<?php echo $vo['title']; ?>&res=<?php echo $vo['resaddress']; ?>" download="<?php echo $vo['title']; ?>" target="blank" id="">下载</a>
