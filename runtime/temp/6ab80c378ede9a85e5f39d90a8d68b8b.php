<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\xampp\htdocs\application/application/index\view\teacher\resource.html";i:1518061157;s:75:"D:\xampp\htdocs\application/application/index\view\common\teacher_head.html";i:1518003728;s:71:"D:\xampp\htdocs\application/application/index\view\common\leftMinu.html";i:1518003728;s:69:"D:\xampp\htdocs\application/application/index\view\common\static.html";i:1517651492;}*/ ?>
<!-- 头部引入 -->
            ...
            <div class="source_box">
                ...
                <div class="resource_nav">
                    <ul class="nav_ul">
                        ...
                        <!-- <li class="book active">
                            <a href="<?php echo url('/index/teacher/resource?book'); ?>">教材</a>
                        </li>
                        <li class="outline">
                            <a href="<?php echo url('/index/teacher/resource?outline'); ?>">大纲</a>
                        </li>
                        <li class="courseware">
                            <a href="<?php echo url('/index/teacher/resource?courseware'); ?>">课件</a>
                        </li>
                        <li class="video">
                            <a href="<?php echo url('/index/teacher/resource?video'); ?>">微课</a>
                        </li>
                        <li class="material">
                            <a href="<?php echo url('/index/teacher/resource?material'); ?>">素材</a>
                        </li>
                        <li class="testpaper">
                            <a href="<?php echo url('/index/teacher/resource?testpaper'); ?>">试卷</a>
                        </li> -->
                    </ul>
                </div>
