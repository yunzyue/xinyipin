<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\heheyun/application/admin\view\resource\testpaper.html";i:1519715858;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('resource/testadd')): ?>
                <a href="<?php echo url('resource/testadd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加教材</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form action="<?php echo url('admin/resource/testpaper'); ?>" id='commentForm' role="form" method="post" class="form-inline pull-right">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <th data-field="allpath">所属分类</th>
                        <th data-field="readcount">阅读数量</th>
                        <th data-field="downcount">下载数量</th>
...
<script type="text/javascript">
    ...
    function userDel(id){
        layer.confirm('确认删除此管理员?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('resource/testDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
