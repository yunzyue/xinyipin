<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\heheyun/application/admin\view\resource\prelesson.html";i:1519864655;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('resource/prelessonadd')): ?>
                <a href="<?php echo url('resource/prelessonadd'); ?>">
...
<script type="text/javascript">
    ...
    function userDel(id){
        layer.confirm('确认删除此管理员?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('resource/prelessonDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
