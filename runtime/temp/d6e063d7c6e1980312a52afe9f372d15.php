<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp64\www\heheyun/application/index\view\parents\taskrightlist.html";i:1518090189;}*/ ?>
 <?php if($taskrightlist !==''): if(is_array($taskrightlist) || $taskrightlist instanceof \think\Collection || $taskrightlist instanceof \think\Paginator): $i = 0; $__LIST__ = $taskrightlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<li class="source_li">
		    ...
		    <div class="operate_a float_right">
				...
				<?php if($vo['order']==4): ?>
		        	<a class="float_right" href="<?php echo url('/index/parents/task_detail',array('homeworkid'=>$vo['id'],'studentid'=>$vo['studentid'])); ?>" onclick="">查看</a>
		        <?php else: ?>
					<a class="float_right" href="" onclick=""></a>
		        <?php endif; ?>
		    </div>
		</li>
