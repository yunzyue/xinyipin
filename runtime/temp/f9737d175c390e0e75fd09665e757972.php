<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\heheyun/application/admin\view\circle\classcircle.html";i:1518090191;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="wrap_head">
			...
			<div class="fle wrap_lis" style="margin-left: 20px;">
				...
				<input style="width: 130px;" type="text" calendar="YYYY-MM-DD hh:mm:ss" name="setData" id="setData" class="fle" value="<?php echo $send; ?>">
			</div>
			<div class="fle wrap_lis">
				<span class="fle">至</span>
				<input style="width: 130px;" type="text" calendar="YYYY-MM-DD hh:mm:ss"  name="edData" id="edData" class="fle" value="<?php echo $sstart; ?>">
			</div>
