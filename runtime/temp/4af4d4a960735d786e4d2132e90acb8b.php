<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\wamp64\www\heheyun/application/admin\view\resource\index.html";i:1519865828;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('resource/videoadd')): ?>
                <a href="<?php echo url('resource/videoadd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加微课</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form action="<?php echo url('admin/resource/index'); ?>" id='commentForm' role="form" method="post" class="form-inline pull-right">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        <thead>
                        <th data-field="id">微课ID</th>
                        <th data-field="title">名称</th>
                        <th data-field="allpath">所属分类</th>
                        <th data-field="readcount">观看次数</th>
