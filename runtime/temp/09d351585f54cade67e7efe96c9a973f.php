<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\xampp\htdocs\application/application/admin\view\index.html";i:1516154815;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2019 <a href="http://heheeduyun.com" target="_blank">heheeduyun.com</a>
            </div>
        </div>
    </div>
...
<script src="__STATIC__/admin/js/hplus.min.js?v=4.1.0"></script>
<!--<script type="text/javascript" src="__STATIC__/admin/js/contabs.min.js"></script>-->
<script type="text/javascript" src="__STATIC__/admin/js/contabs.js"></script>
