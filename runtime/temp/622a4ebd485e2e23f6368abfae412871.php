<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\wamp64\www\heheyun/application/index\view\teacher\cloudspace.html";i:1519796121;s:69:"D:\wamp64\www\heheyun/application/index\view\common\teacher_head.html";i:1519786633;s:65:"D:\wamp64\www\heheyun/application/index\view\common\leftMinu.html";i:1519715857;s:63:"D:\wamp64\www\heheyun/application/index\view\common\static.html";i:1519786633;}*/ ?>
<!-- 头部引入 -->
...
<div class="my_source resource">
    ...
    <div class="source_head head_04">
        <div class="head_li">
            <a href="<?php echo url('/index/teacher/resource?book'); ?>">个人资源</a>
            <a class="active" href="<?php echo url('/index/teacher/cloudSpace'); ?>">云空间</a>
        </div>
    </div>
    <!-- 操作按钮 -->
    <div class="operate_btn" id="<?php echo $id; ?>">
        ...
        <div id="container">
            <a class="upload_a" style="display: block;" id="selectfiles" href="javascript:void(0);" class='btn'>上传</a>
    ...
    <div class="navigation_bar">
    	...
    	<?php if($id==0): ?>
	        <div class="nav_a">
	            <a href="<?php echo url('/index/teacher/cloudSpace'); ?>">全部文件</a>
	        </div>
	    <?php else: ?>
           <div class="nav_a has_pid">
           		<a class="goBack" href="<?php echo url('index/teacher/nextcatalog',array('id'=>$pid)); ?>">返回上一级</a>
	            <a href="<?php echo url('/index/teacher/cloudSpace'); ?>">全部文件</a>
	        </div>
        <?php endif; ?>   
        <span class="data_num">
                ...
                <?php if($cataloglist!=''): if(is_array($cataloglist) || $cataloglist instanceof \think\Collection || $cataloglist instanceof \think\Paginator): $i = 0; $__LIST__ = $cataloglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li class="source_li" file_type="<?php echo $vo['type']; ?>" id="<?php echo $vo['id']; ?>">
                            <div class="img_box">
                            		...
                            		<?php if($vo['type']==1): ?>
                            			<a href="<?php echo url('index/teacher/nextcatalog',array('id'=>$vo['id'])); ?>">
    	                            	<img class="file_icon" src="__STATIC__/index/teacher/img/folder.png">       
					               		</a>
                                <span class="span_icon"></span>
                            </div>
                                    <a href="<?php echo url('index/teacher/nextcatalog',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" class="file_name"><?php echo $vo['title']; ?></a>
